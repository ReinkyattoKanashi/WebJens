...
interface ApiRequests {
    ...
    @GET("./game_get_server")
    fun getServer(@Query("token") token: String, @Query("server_id") serverId: String): Call<ServerDetailInfo>

    @GET("./user_get_data")
    fun getUserData(@Query("token") token: String): Call<ProfileData>

    @GET("./game_send_action")
    fun sendServerAction(@Query("token") token: String, @Query("server_id") serverId: String, @Query("server_action") action: String): Call<ServerAction>
